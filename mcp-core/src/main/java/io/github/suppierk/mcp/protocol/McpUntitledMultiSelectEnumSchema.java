 ...
 * @param items Schema for the array items.
...
public record McpUntitledMultiSelectEnumSchema(
  ...
  /**
   * Creates a builder for {@link McpUntitledMultiSelectEnumSchema}.
   *
   * @return a new builder
   */
  public static Builder mcpUntitledMultiSelectEnumSchema() {
    return new Builder();
  }

  /** Builds {@link McpUntitledMultiSelectEnumSchema} values. */
  public static final class Builder {
     ...
     */
    public McpUntitledMultiSelectEnumSchema build() {
      return new McpUntitledMultiSelectEnumSchema(
