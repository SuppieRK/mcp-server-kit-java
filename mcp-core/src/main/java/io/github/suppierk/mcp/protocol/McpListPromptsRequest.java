 ...
 */
public record McpListPromptsRequest(JsonNode id, McpPaginatedRequestParams params)
  ...
  /**
   * Creates a builder for {@link McpListPromptsRequest}.
   *
   * @return a new builder
   */
  public static Builder mcpListPromptsRequest() {
    return new Builder();
  }

  /** Builds {@link McpListPromptsRequest} values. */
  public static final class Builder {
     ...
     */
    public McpListPromptsRequest build() {
      return new McpListPromptsRequest(id, params);
    }
  }
}
