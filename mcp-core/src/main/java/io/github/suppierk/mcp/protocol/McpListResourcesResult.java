...
public record McpListResourcesResult(
  ...
  /**
   * Creates a builder for {@link McpListResourcesResult}.
   *
   * @return a new builder
   */
  public static Builder mcpListResourcesResult() {
    return new Builder();
  }

  /** Builds {@link McpListResourcesResult} values. */
  public static final class Builder {
    ...
    public McpListResourcesResult build() {
      return new McpListResourcesResult(meta, cacheScope, nextCursor, resources, resultType, ttlMs);
    }
  }
}
