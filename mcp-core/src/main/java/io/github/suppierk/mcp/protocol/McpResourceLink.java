 ...
 * does not appear in a {@link McpListResourcesRequest} ({@code resources/list}) result.
 *
...
public record McpResourceLink(
    ...
    URI uri)
    implements McpBaseMetadata, McpContentBlock {

  private static final String TYPE = "resource_link";
  ...
  /**
   * Creates a builder for {@link McpResourceLink}.
   *
   * @return a new builder
   */
  public static Builder mcpResourceLink() {
    return new Builder();
  }

  /** Builds {@link McpResourceLink} values. */
