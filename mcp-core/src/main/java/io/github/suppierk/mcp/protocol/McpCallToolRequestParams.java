...
public record McpCallToolRequestParams(
  ...
  public McpCallToolRequestParams {
  ...
  /**
   * Returns a copy of the optional tool arguments.
   *
  ...
  /**
   * Creates a builder for {@link McpCallToolRequestParams}.
   *
   * @return a new builder
   */
  public static Builder mcpCallToolRequestParams() {
    return new Builder();
  }

  /** Builds {@link McpCallToolRequestParams} values. */
  public static final class Builder {
     ...
     */
    public McpCallToolRequestParams build() {
      return new McpCallToolRequestParams(meta, arguments, inputResponses, name, requestState);
    }
  }
}
